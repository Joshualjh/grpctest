...
func (x *GetUserReponse) GetUserMessage() *UserMessage {
	if x != nil {
...
func (x *ListUsersReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListUsersReponse) ProtoMessage() {}

func (x *ListUsersReponse) ProtoReflect() protoreflect.Message {
	mi := &file_protos_v1_user_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListUsersReponse.ProtoReflect.Descriptor instead.
func (*ListUsersReponse) Descriptor() ([]byte, []int) {
	return file_protos_v1_user_user_proto_rawDescGZIP(), []int{4}
}

func (x *ListUsersReponse) GetUserMessages() []*UserMessage {
	if x != nil {
...
var file_protos_v1_user_user_proto_rawDesc = []byte{
	...
	0x22, 0x49, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6f, 0x6e,
	...
	0x4d, 0x0a, 0x10, 0x4c, 0x69, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x73, 0x52, 0x65, 0x70, 0x6f,
	...
	,
...
var file_protos_v1_user_user_proto_goTypes = []interface{}{
	...
	(*GetUserReponse)(nil),   // 2: v1.user.GetUserReponse
	(*ListUsersRequest)(nil), // 3: v1.user.ListUsersRequest
	(*ListUsersReponse)(nil), // 4: v1.user.ListUsersReponse
}
var file_protos_v1_user_user_proto_depIdxs = []int32{
	0, // 0: v1.user.GetUserReponse.user_message:type_name -> v1.user.UserMessage
	0, // 1: v1.user.ListUsersReponse.user_messages:type_name -> v1.user.UserMessage
	1, // 2: v1.user.User.GetUser:input_type -> v1.user.GetUserRequest
	3, // 3: v1.user.User.ListUsers:input_type -> v1.user.ListUsersRequest
	2, // 4: v1.user.User.GetUser:output_type -> v1.user.GetUserReponse
	4, // 5: v1.user.User.ListUsers:output_type -> v1.user.ListUsersReponse
