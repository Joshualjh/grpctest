...
type UserClient interface {
	...
	ListUsers(ctx context.Context, in *ListUsersRequest, opts ...grpc.CallOption) (*ListUsersReponse, error)
}
...
func (c *userClient) GetUser(ctx context.Context, in *GetUserRequest, opts ...grpc.CallOption) (*GetUserReponse, error) {
...
func (c *userClient) ListUsers(ctx context.Context, in *ListUsersRequest, opts ...grpc.CallOption) (*ListUsersReponse, error) {
	out := new(ListUsersReponse)
...
type UserServer interface {
	...
	ListUsers(context.Context, *ListUsersRequest) (*ListUsersReponse, error)
...
func (UnimplementedUserServer) GetUser(context.Context, *GetUserRequest) (*GetUserReponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetUser not implemented")
}
func (UnimplementedUserServer) ListUsers(context.Context, *ListUsersRequest) (*ListUsersReponse, error) {
